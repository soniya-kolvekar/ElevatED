        ...
        <div className="p-8 max-w-[1400px] mx-auto space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex justify-between items-start">
                ...
                <div className="flex gap-3">
                    ...
                    <Button className="rounded-xl bg-mutedTeal hover:bg-jungle text-white shadow-soft flex items-center gap-2 px-5 font-bold transition-all">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    <Card className="p-6 border-none shadow-soft group hover:translate-y-[-2px] transition-all">
                        ...
                        <div className="mt-6 w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                            <div className="h-full bg-mutedTeal w-[70%] group-hover:w-[75%] transition-all duration-1000"></div>
                        </div>
                    </Card>
                    ...
                    <Card className="p-6 border-none shadow-soft group hover:translate-y-[-2px] transition-all">
                        ...
                        <div className="mt-6 w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                            <div className="h-full bg-mutedTeal w-[60%] group-hover:w-[65%] transition-all duration-1000"></div>
                        </div>
                    </Card>
                    ...
                    <Card className="p-6 border-none shadow-soft group hover:translate-y-[-2px] transition-all">
                        ...
                        <div className="mt-6 w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                            <div className="h-full bg-mutedTeal w-[80%] group-hover:w-[85%] transition-all duration-1000"></div>
                        </div>
                    </Card>
                </div>
                ...
                <Card className="border-none shadow-soft overflow-hidden">
                    <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-white">
                        ...
                        <div className="flex items-center gap-4">
                            <span className="bg-mutedTeal/10 text-mutedTeal text-[10px] font-black px-2 py-1 rounded-md">AI SORTED</span>
                                    ...
                                    <tr key={cand.id} className="group hover:bg-[#f8fafa] transition-colors">
                                        ...
                                        <td className="py-6 px-8">
                                            <div className="flex items-center gap-2 text-lg font-black text-[#1a1a1a]">
                                                {cand.atx}
                                                <TrendingUp className="w-4 h-4 text-mutedTeal" />
                                            </div>
                                        </td>
                                        <td className="py-6 px-8">
